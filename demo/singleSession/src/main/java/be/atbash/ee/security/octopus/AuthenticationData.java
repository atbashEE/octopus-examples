/*
 * Copyright 2019 Rudy De Busscher (www.atbash.be)
 *
...
public class AuthenticationData extends AuthenticationInfoProvider {
    ...
    public AuthenticationInfo getAuthenticationInfo(AuthenticationToken token) {
        ...
        if (token instanceof UsernamePasswordToken) {
            ...
            authenticationInfoBuilder.principalId(usernamePasswordToken.getUsername())  // Important here, same user needs to have same id
                    .name(usernamePasswordToken.getUsername());
